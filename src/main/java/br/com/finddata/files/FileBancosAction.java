 ...
 * @author Tiago
 */
public class FileBancosAction extends FileAction {
    
    public FileBancosAction(String fileLocation, String fileName) {
    ...
    public List<InstituicaoFinanceira> READ_FILE() throws IOException {
        ...
        ArrayList<InstituicaoFinanceira> bancos = new ArrayList<>();
